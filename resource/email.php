...
*
$mail = new MySendMail();
//$mail->setServer("smtp.qq.com", "727448429@qq.com", "zqf8825001qqq"); //设置smtp服务器，普通连接方式
$mail->setServer("smtp.qq.com", "727448429@qq.com", "ugcvyjaozwynbfef", 465, true); //设置smtp服务器，到服务器的SSL连接
$mail->setFrom("727448429@qq.com"); //设置发件人
$mail->setReceiver("727448429@qq.com"); //设置收件人，多个收件人，调用多次
$mail->setCc("727448429@qq.com"); //设置抄送，多个抄送，调用多次
...
class code{
    ...
    public function encrypt($key, $txt)
    {
    ...
    public function decrypt($key, $txt)
    {
        $chars = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_.";
        $ikey ="-x6g6ZWm2G9g_vr0Bo.pOq3kRIxsZ6rm";
        $knum = 0;$i = 0;
...
class MySendMail {
    ...
    */
    protected function socketSecurity() {
        ...
        //$this->_socket = stream_socket_client($remoteAddr, $errno, $errstr, 30); 由于该函数被限制，故使用fsockopen 来解决，若使用此函数记住$remoteAddr 需带上端口
